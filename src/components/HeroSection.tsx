    ...
    <section id="inicio" className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 text-center">
        ...
        >
          <a
            href="#contacto"
            className="px-8 py-3.5 rounded-full bg-gradient-primary text-primary-foreground font-semibold text-base hover:opacity-90 transition-opacity inline-flex items-center gap-2"
          >

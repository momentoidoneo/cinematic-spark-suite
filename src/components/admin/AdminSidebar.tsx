import { LayoutDashboard, Image, FolderOpen, Layers, Settings } from "lucide-react";
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-border">
      <div className="h-14 border-b border-border flex items-center px-4 gap-2">
        <div className="w-8 h-8 rounded-lg bg-gradient-primary flex items-center justify-center text-primary-foreground font-bold text-sm">SC</div>
